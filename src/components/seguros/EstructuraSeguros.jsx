					...
					<div className="paginas">
						<div className="modulo">
							<div className="grupo">
								...
								{
									pagina.tipo_formulario == null ? (<Link to={{pathname: '/formulario/tipo', state: [{tipoSeguro: (estado.tipoSeguro !== "undefined") ? estado.tipoSeguro : null, nombreSeguro: pagina.titulo, urlIcon: estado.urlIcon, path: window.location.href}] }}><a className="boton"><span>Solicitar</span></a></Link>) : (null)
								}
