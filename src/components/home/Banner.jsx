    ...
    return (
        <div>
            <section className="banner primera">
															...
															
															{
																segurosP.map(item => (
																	<Link to={{
																		...
																		state: {tipoSeguro: 'Personas', nombre: item.titulo_ICONO, origen:'home', urlIcon:`http://192.99.166.101:3001${item.ICONO.url}` }
																	...
																	<img className="img-fluid ico v1" src={`http://192.99.166.101:3001${item.ICONO.url}`} alt=""/>
																	<img className="img-fluid ico v2" src={`http://192.99.166.101:3001${item.ICONO_BLANCO.url}`} alt=""/>
																	</div>
				...
				<img className="img-fluid" src="http://192.99.166.101:3001/uploads/ilustracion0_0a3264ede9.png" alt=""/>
			</section>
        </div>
    )
}
