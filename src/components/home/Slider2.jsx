...
const Slider2 = () => {
	...
	const puntoDos = () => {
		if (slider2) {
			return (
				<li className={active2 ? 'active' : null}>
					<a onClick={activePointTwo}>2</a>
				</li>
			);
		}
	};
	const puntoTres = () => {
		if (slider3) {
			return (
				<li className={active3 ? 'active' : null}>
					<a onClick={activePointThree}>3</a>
				</li>
			);
		}
	};
	const puntoCuatro = () => {
		if (slider4) {
			return (
				<li className={active4 ? 'active' : null}>
					<a onClick={activePointFour}>4</a>
				</li>
			);
		}
	};
	...
	const puntoCinco = () => {
		if (slider5) {
			return (
				<li className={active5 ? 'active' : null}>
					<a onClick={activePointFive}>5</a>
				</li>
			);
		}
	};
								...
								<div className="carrusel">
									<div className="lSSlideOuter ">
										<div className="lSSlideWrapper usingCss">
											<div
												id="slide"
												className="lightSlider lSFade"
												style={{ height: '0px', paddingBottom: '34.9485%' }}
											>
												<div
													style={{ display: active1 ? '' : 'none' }}
												...
												>
													<div className="row">
														<div className="col-12 col-lg-6">
															{slider.titulo ? (
																<h3
																	dangerouslySetInnerHTML={{ __html: slider.titulo }}
																/>
															) : (
																<h3>Sin Titulo</h3>
															)}
															...
															{slider.texto_boton ? (
																<div className="clearfix">
																	<a
																		target="_blank"
																		href={slider.URL_boton}
																		className="boton"
																	>
																		<span>{slider.texto_boton}</span>
																	</a>
																</div>
															) : null}
														</div>
															...
															<div className="centrar">
																{destacada ? (
																	<img
																		className="img-fluid"
																		src={`${process.env
																			.REACT_APP_API_URL}${destacada}`}
																		alt=""
																	/>
																) : (
																	<img
																		className="img-fluid"
																		src="https://www.allianceplast.com/wp-content/uploads/2017/11/no-image-300x300.png"
																		alt=""
																	/>
																)}{' '}
															</div>
												...
												{slider2 ? (
													<div
														style={{ display: active2 ? '' : 'none' }}
														className={`modulo2 modulo lslide ${active2
															? 'active'
															: 'none'}`}
													>
														<div className="row">
															<div className="col-12 col-lg-6">
																...
																{slider2.texto_boton ? (
																	<div className="clearfix">
																		<a
																			href={slider2.URL_boton}
																			target="_blank"
																			className="boton"
																		>
																			<span>{slider2.texto_boton}</span>
																		</a>
																	</div>
																) : null}
															</div>
												...
												{slider3 ? (
													<div
														style={{ display: active3 ? '' : 'none' }}
														className={`modulo lslide ${active3 ? 'active' : 'none'}`}
													>
														<div className="row">
															<div className="col-12 col-lg-6">
																{slider3.titulo ? (
																...
																{slider3.texto_boton ? (
																	<div className="clearfix">
																		<a
																			target="_blank"
																			href={slider3.URL_boton}
																			className="boton"
																		>
																			<span>{slider3.texto_boton}</span>
																		</a>
																	</div>
																) : null}
															</div>
												...
												{slider4 ? (
													<div
														style={{ display: active4 ? '' : 'none' }}
														className={`modulo lslide ${active4 ? 'active' : 'none'}`}
													>
														<div className="row">
															<div className="col-12 col-lg-6">
																{slider4.titulo ? (
																...
																{slider4.texto_boton ? (
																	<div className="clearfix">
																		<a
																			target="_blank"
																			href={slider4.URL_boton}
																			className="boton"
																		>
																			<span>{slider4.texto_boton}</span>
																		</a>
																	</div>
																) : null}
															</div>
												...
												{slider5 ? (
													<div
														style={{ display: active5 ? '' : 'none' }}
														className={`modulo lslide ${active5 ? 'active' : 'none'}`}
													>
														<div className="row">
															<div className="col-12 col-lg-6">
																{slider5.titulo ? (
																...
																{slider5.texto_boton ? (
																	<div className="clearfix">
																		<a
																			target="_blank"
																			href={slider5.URL_boton}
																			className="boton"
																		>
																			<span>{slider5.texto_boton}</span>
																		</a>
																	</div>
																) : null}
															</div>
										...
										<ul className="lSPager lSpg" style={{ marginTop: '5px' }}>
											<li className={active1 ? 'active' : null}>
												<a onClick={activePointOne}>1</a>
											</li>
