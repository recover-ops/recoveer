										...
										<div className="lSSlideOuter ">
											<div className="lSSlideWrapper usingCss">
												...
												>
																		...
																		<div className="col-3 col-lg-3">
																			<div className="centrar">
																				<img
																					...
																					src={`http://192.99.166.101:3001${destacada2}`}
																					alt=""
																				/>
																			</div>
																		</div>
																	...
																	<div className="row">
																		<div className="col-3 col-lg-3">
																			<div className="centrar">
																				<img
																					className="img-fluid ico"
																					src={`http://192.99.166.101:3001${destacada3}`}
																					alt=""
																				/>
																			</div>
																		</div>
													...
													<div
														className="modulo lslide active"
														style={{
															width: '555px',
															marginRight: '0px',
															display: active1 ? '' : 'none'
														}}
													>
																	...
																	<div className="row">
																		<div className="col-3 col-lg-3">
																			<div className="centrar">
																				<img
																					className="img-fluid ico"
																					src={`http://192.99.166.101:3001${destacada}`}
																					alt=""
																				/>
																			</div>
																		</div>
													...
													<div
														className="modulo lslide"
														style={{
															width: '555px',
															marginRight: '0px',
															display: !active3 ? '' : 'none'
														}}
													>
														<div className="int">
															<div className="encabezado">
